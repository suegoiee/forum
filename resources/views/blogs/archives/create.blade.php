...
@section('content')
    <h1 style="font-size:25px; color:#393939;">撰寫專欄</h1>
    ...
    <div class="alert" style="background: rgba(255,255,255,0.9);border-left: 3px solid #0084ff;color: #393939;box-shadow: 2px 2px 2px 0px rgba(2%,2%,4%,0.12);">
        <p> 
            ...
            請先嘗試使用
            <a href="{{ route('blogs') }}" style="color:#ffa500; font-weight:bolder;">搜索框</a> 查詢您的問題並確認在發表文章前已瞭解
    ...
    @include('blogs.archives._blogs', ['route' => 'archives.store'])
@endsection
