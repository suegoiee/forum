@if (session()->has('error'))
    <div class="alert alert-dismissible" style="background: rgba(255,255,255,0.9);border-left: 3px solid #ef3474;color: #393939 !important;box-shadow: 2px 2px 2px 0px rgba(2%,2%,4%,0.12);">
